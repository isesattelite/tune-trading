...
export function handleBurn(event: Burn): void {
  ...
  burnRecord.timestamp3 = event.block.timestamp
...
export function handleMint(event: Mint): void {
  ...
  mintRecord.timestamp3 = event.block.timestamp
...
export function handleSwap(event: Swap): void {
  ...
  swapRecord.timestamp3 = event.block.timestamp
...
export function handleSync(event: Sync): void {
  ...
  reserveRecord.timestamp3 = event.block.timestamp
