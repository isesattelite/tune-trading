...
export class ReseveRecord extends Entity {
  constructor(id: string) {
    ...
    this.set("timestamp3", Value.fromBigInt(BigInt.zero()));
  }
  ...
  get timestamp3(): BigInt {
    let value = this.get("timestamp3");
    return value!.toBigInt();
  }

  set timestamp3(value: BigInt) {
    this.set("timestamp3", Value.fromBigInt(value));
  }
}
